        ...
        <ul class="dropdown-menu">
            ...
            <li class="dropdown<?php if ($cat->childs_num) echo '-submenu'; ?><?php /*if(\Joomla\CMS\Factory::getApplication()->input->getInt('cat_id') == $cat->id) echo ' open';*/ ?>">
                ...
                <a class="dropdown-item"
                   href="<?php echo $category->link; ?>"><?php echo JText::_('CMORECATS') . '...' ?></a></li>
				<?php break; ?>
			<?php else: ?>
...
<nav class="navbar navbar-expand-lg bg-light">
    <div class="container-fluid">
		<?php if ($params->get('show_section', 1)) : ?>
            <a class="navbar-brand" href="<?php echo JRoute::_(Url::records($section)) ?>">
            ...
            <ul class="navbar-nav">
				<?php foreach ($categories as $cat) :
                    ...
                    <li class="nav-item <?php echo $hasSubCats ? 'dropdown' : '' ?>">
                            ...
                            <a <?php echo $hasSubCats ? 'data-bs-toggle="dropdown" aria-expanded="false"' : ''  ?> class="nav-link <?php echo $hasSubCats ? 'dropdown-toggle' : '' ?>" href="<?php echo $hasSubCats ? '#' : JRoute::_($cat->link) ?>">
				            <?php echo $cat->title; ?>
				...
				<?php if ($params->get('records') && $section->records):
					foreach ($section->records as $i => $rec):
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link" href="<?php echo JRoute::_($rec->url) ?>">
								<?php echo $rec->title; ?>
                            </a>
                        </li>
					<?php endforeach; ?>
