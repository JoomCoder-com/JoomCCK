...
class com_joomcckInstallerScript
{
	...
	public function _updateTables($update = true)
	{
		...
		$db->setQuery("SET NAMES utf8mb4 COLLATE utf8mb4_unicode_ci");
		$db->execute();
			...
			if (in_array($table, $list)) {
				...
				foreach ($source->fields as $field) {
					...
					if (empty($info[$field->name])) {
						$sql = "ALTER TABLE `{$table}` ADD COLUMN " . $update_field;
					} elseif (
						...
						$sql = "ALTER TABLE `{$table}` CHANGE COLUMN `{$field->name}` " . $update_field;
					}
				...
				// Convert existing table to utf8mb4 for emoji support
				$db->setQuery("ALTER TABLE `{$table}` CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci");
				$db->execute();
				if ($update) {
					\Joomla\CMS\Factory::getApplication()->enqueueMessage("Table converted to utf8mb4: " . $table);
				}
				...
				// Updated to use utf8mb4 for emoji support
				$query = sprintf(
					"CREATE TABLE IF NOT EXISTS `%s` (%s) ENGINE=%s DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;",
					$table,
					implode(",  ", $sql),
					$source->engine
				);
		...
		// Rest of the method remains the same for inserting default data
    ...
    private function _deleteFiles59()
    {
        $files = [
	        ...
	        '/language/en-GB/com_joomcck_field_html.ini',
	        '/language/en-GB/com_joomcck_field_image.ini',
	        '/language/en-GB/com_joomcck_field_j2store.ini',
	        '/language/en-GB/com_joomcck_field_listautocomplete.ini',
	        '/language/en-GB/com_joomcck_field_multislevelselect.ini',
	        '/language/en-GB/com_joomcck_field_multiselect.ini',
	        '/language/en-GB/com_joomcck_field_parent.ini',
	        '/language/en-GB/com_joomcck_field_child.ini',
	        '/language/en-GB/com_joomcck_field_passwd.ini',
	        '/language/en-GB/com_joomcck_field_paytoaccess.ini',
	        '/language/en-GB/com_joomcck_field_paytodownload.ini',
	        '/language/en-GB/com_joomcck_field_payvoucher.ini',
	        '/language/en-GB/com_joomcck_field_q2c.ini',
	        '/language/en-GB/com_joomcck_field_radio.ini',
	        '/language/en-GB/com_joomcck_field_readmore.ini',
	        '/language/en-GB/com_joomcck_field_records.ini',
	        '/language/en-GB/com_joomcck_field_register.ini',
	        '/language/en-GB/com_joomcck_field_related_access.ini',
	        '/language/en-GB/com_joomcck_field_select.ini',
	        '/language/en-GB/com_joomcck_field_status.ini',
	        '/language/en-GB/com_joomcck_field_telephone.ini',
	        '/language/en-GB/com_joomcck_field_text.ini',
	        '/language/en-GB/com_joomcck_field_textarea.ini',
	        '/language/en-GB/com_joomcck_field_uploads.ini',
	        '/language/en-GB/com_joomcck_field_url.ini',
	        '/language/en-GB/com_joomcck_field_video.ini',
	        '/language/en-GB/com_joomcck_field_paypal.ini',
	        '/language/en-GB/com_joomcck_field_robokassa.ini',
	        '/language/en-GB/com_joomcck_field_url.ini',
	        '/language/en-GB/com_joomcck_field_url.ini',
	        '/language/en-GB/com_joomcck_field_url.ini',
