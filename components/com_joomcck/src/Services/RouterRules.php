 ...
 * @since  3.4
 */
class RouterRules implements RulesInterface
{
    /**
    ...
    public static function toBuild(&$query)
    {
    ...
    public static function toParse($segments)
    {
