		...
		<tr>
			<td>
				<span class="flag_icon" id="flag<?php echo $this->id;?>">
					<?php if ($this->flag): ?>
						<img src="<?php echo \Joomla\CMS\Uri\Uri::root(TRUE);?>/media/com_joomcck/<?php echo ($this->flag ? 'icons/flag/16/'.\Joomla\String\StringHelper::strtolower($this->flag->code2) : 'blank');?>.png" border="0" 
