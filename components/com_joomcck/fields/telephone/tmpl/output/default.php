...
<?php if($this->params->get('params.qr_code', 0)):?>
	...
	<img style="cursor: pointer" src="<?php echo JURI::root(true) ?>/media/com_joomcck/icons/16/barcode-2d.png" rel="popover" data-content="<?php echo htmlentities($img, ENT_QUOTES);?>" data-original-title="<?php echo JText::_('T_QR');?>">
<?php endif; ?>
