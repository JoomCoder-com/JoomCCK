...
foreach($this->values as $key => $value) :
    ...
    <div class="form-check form-check-inline">
        ...
        <label class="form-check-label" for="filterInlineCheckbox<?php echo $this->key;?>-<?php echo $key ?>"><?php echo $label;?> <span class="badge text-bg-light shadow-sm px-2 py-1"><?php echo ($this->params->get('params.filter_show_number', 1) ? $value->num : NULL);?></span></label>
    </div>
