...
<select class="form-select mb-3" name="filters[<?php echo $this->key;?>][by]" data-bs-original-title="<?php echo \Joomla\CMS\Language\Text::_('CFILTERCONDITION')?>" rel="tooltip">
...
foreach($this->values as $key => $value) :
    ...
    <div class="d-inline">
        ...
        <label class="btn btn-outline-success" for="filterInlineCheckbox<?php echo $this->key;?>-<?php echo $key ?>"><?php echo $label;?> <span class="badge text-bg-light shadow-sm px-2 py-1"><?php echo ($this->params->get('params.filter_show_number', 1) ? $value->num : NULL);?></span></label>
    </div>
