...
?>
    ...
    <div class="row">
        <div class="col-md-6">
	        <?php echo JHtml::_('mrelements.pills', "filters[{$this->key}][value]", "filter_" . $this->id, $default, array(), $options); ?>

        </div>
        <div class="col-md-6 mt-sm-3 mt-md-0">
	        <?php if($this->params->get('params.total_limit') != 1):?>
                <select class="form-select" name="filters[<?php echo $this->key;?>][by]" title="<?php echo JText::_('CSELECTFILTERCONDITION')?>" rel="tooltip">
