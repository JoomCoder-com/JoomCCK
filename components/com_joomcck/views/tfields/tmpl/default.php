		...
		foreach($this->items as $i => $item):
			...
			<tr sortable-group-id="<?php echo $item->group_id ?>">
				...
				<td nowrap="nowrap">
					...
					?>
					<small><a href="#" rel="tooltip" data-original-title="<?php echo JText::_('CFILTERFIELDTYPE') ?>" onclick="Joomcck.setAndSubmit('filter_ftype', '<?php echo $item->field_type ?>')"><?php echo $item->field_type ?></a></small>
				</td>
				<td class="center">
