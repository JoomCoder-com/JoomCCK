...
{
	$replay = '<a class="btn btn-mini btn-primary" href="#commentmodal" data-toggle="modal" role="button" onclick="Joomcck.editComment(0, '.$this->comment->id.', '.$this->item->id.')"><i class="icon-comments-2"></i> ' . JText::_('CREPLY') . '</a>';
}
