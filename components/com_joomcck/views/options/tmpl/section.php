...
<form name="adminForm" id="adminForm" method="post" class="form-horizontal">
	...
	<div class="row">
		...
		<div class="mb-3">
			<label for="userTitle" class="form-label"><?php echo JText::_('CMYHOMEPAGETITLE'); ?></label>
		...
		<div class="mb-3">
            <label for="jform_description" rel="tooltip" class="form-label" title="<?php echo JText::_('CMYHOMEPAGEMSGDESCR');?>"><?php echo JText::_('CMYHOMEPAGEMSG'); ?></label>
		...
		<?php if($params->get('personalize.allow_access_control_add', 1) && $this->section->params->get('personalize.post_anywhere')): ?>
			<div class="mb-3">
				<label for="userWhoPost" class="form-label"><?php echo JText::_('CWHOCANPOSTINMYHAMOPAGE'); ?></label>
		...
		<?php if($params->get('personalize.allow_access_control', 1) && $this->section->params->get('events.subscribe_user')): ?>
			<div class="mb-3">
				<label for="userWhoViewBookmarked" class="form-label"><?php echo JText::_('CWHOCANVIEWMYBOOKMARKS'); ?></label>
			...
			<div class="mb-3">
				<label class="form-label" for="userWhoViewRated"><?php echo JText::_('CWHOCANVIEWMYRATEDRECORDS'); ?></label>
			...
			<div class="mb-3">
				<label class="form-label" for="userWhoViewCommented"><?php echo JText::_('CWHOCANVIEWMYCOMMENTEDRECORDS'); ?></label>
			...
			<div class="mb-3">
				<label for="userWhoViewVisited" class="form-label"><?php echo JText::_('CWHOCANVIEWMYVISITEDRECORDS'); ?></label>
			...
			<div class="mb-3">
				<label for="userWhoViewFollowed" class="form-label"><?php echo JText::_('CWHOCANVIEWMYFOLLOWEDRECORDS'); ?></label>
