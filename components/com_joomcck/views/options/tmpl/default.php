                    ...
                    <div class="card-body">
                        ...
                        <div class="float-end">
                            <button type="button" <?php echo($section->records ? null : 'style="display: none;"'); ?>
                                ...
                                <span class="badge text-bg-light shadow-sm px-2 py-1"><?php echo $section->records; ?></span>
                            </button>
                            <button class="btn"
                                ...
                                <span class="badge text-bg-light shadow-sm px-2 py-1"><?php echo $section->records_total - $section->records; ?></span>
                            </button>
                        </div>
