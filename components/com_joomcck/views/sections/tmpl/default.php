                    ...
                    <tr>
                        ...
                        <td nowrap="nowrap">
                            <a rel="tooltip" data-bs-toggle="tooltip"
                               title="<?php echo \Joomla\CMS\Language\Text::_('CCATEGOY_MANAGE'); ?>"
                               href="<?php echo \Joomla\CMS\Router\Route::_('index.php?option=com_joomcck&view=cats&section_id=' . $item->id) ?>">
