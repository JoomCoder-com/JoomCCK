...
<div id="compare" <?php echo !$this->compare ? 'class="hide"' : '';?>>
	<div class="alert alert-info alert-block">
		...
		<br><a rel="nofollow" href="<?php echo JRoute::_('index.php?option=com_joomcck&view=compare&section_id='.$this->section->id.'&return='.Url::back()); ?>" class="btn btn-primary"><?php echo JText::_('CCOMPAREVIEW');?></a>
		<button onclick="Joomcck.CleanCompare(null, '<?php echo @$this->section->id ?>')" class="btn"><?php echo JText::_('CCLEANCOMPARE');?></button>
	</div>
</div>
						...
						<li class="dropdown me-2" id="joomcck-user-menu">
							...
							<ul class="dropdown-menu">
								...
								<?php if($this->section->params->get('personalize.personalize') && $this->section->params->get('personalize.allow_section_set')):?>
									<li class="divider"></li>
									<li><a href="<?php echo JRoute::_('index.php?option=com_joomcck&view=options&layout=section&section_id='.$this->section->id.'&return='.Url::back());?>">
