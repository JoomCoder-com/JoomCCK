    ...
    <div class="categories-list" style="padding-bottom: 20px;">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                class="mt-4 cat-name<?php echo(\Joomla\CMS\Factory::getApplication()->input->getInt('cat_id') == $category->id ? ' category-active' : null) ?>
                ">
				<?php if ($params->get('tmpl_params.cat_img', 1) && $category->image): ?>
                    <div><img style="max-width:<?php echo $params->get('tmpl_params.cat_img_width', 200) ?>px;"
                              class="category_icon" alt="<?php echo $category->title; ?>"
                              src="<?php echo \Joomla\CMS\Uri\Uri::root() . $category->image; ?>"></div>
				<?php endif; ?>
				<?php if (count($category->children)): ?>
                    <img style="cursor: pointer;" id="iconsubcat<?php echo $category->id; ?>"
                         src="<?php echo \Joomla\CMS\Uri\Uri::root() ?>media/com_joomcck/icons/16/toggle.png" hspace="5"
                         align="absmiddle"/>
				<?php endif; ?>
