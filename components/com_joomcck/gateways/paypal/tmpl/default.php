...
<form action="<?php echo $action; ?>" method="post" class="form-paypal">
	...
	<?php if(!empty($nonehidden)):?>
		...
		<?php endforeach;?>
	<?php endif;?>
	<button class="btn btn-warning" <?php echo (!\Joomla\CMS\Factory::getApplication()->getIdentity()->get('id') ? sprintf(' type="button" rel="tooltip" data-bs-original-title="%s"', \Joomla\CMS\Language\Text::_('SSI_LOGINTOBUY')) : null); ?> type="submit">
