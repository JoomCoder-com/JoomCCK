 ...
 * Modern UI - Settings/controls dropdown for a record in a list.
 *
 * Tailwind CSS variant of core.list.recordParts.controlsMenu. Override to restructure the menu.
